...
class _FlexWell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (label.toString() != null.toString()) {
      ...
      var _brightness = NeuTheme.of(context).brightness;
      child = Text(
...
class _NeuTextSelectionControls extends TextSelectionControls {
...
final TextSelectionControls neuSelectionControls = _NeuTextSelectionControls();
